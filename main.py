...
@dp.message(F.text & F.reply_to_message & F.reply_to_message.text.contains("укажите одно из следующего"))
...
@dp.message(F.photo & F.reply_to_message & F.reply_to_message.text.contains("укажите одно из следующего"))
