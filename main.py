...
async def show_payment_options(user: types.User):
    ...
    "<b>ОПЛАТА ЗА ПРИМЕРКИ ОТ @Vladimir5446 (ID: 973853935)</b>\n"
    ...
    f"<code></b>Оплата за примерки от @{user.username} (ID: {user.id})</b></code>\n\n"
    "Вы увидите, что оно скопировано и вставьте в поле Для на странице оплаты.\n\n"
