...
async def pay_qr_handler(callback_query: types.CallbackQuery):
    ...
    caption = (
        ...
        f"‼️💬<b>ОБЯЗАТЕЛЬНО</b> В комментарий вставьте:\n"
        f"<code>ОПЛАТА ЗА ПРИМЕРКИ от @{user.username or 'username'}</code> <-- нажмите чтобы скопировать\n\n"
...
📞 <code>+7 705 541-27-09</code> <-- нажмите чтобы скопировать
...
‼️6️⃣  ОБЯЗАТЕЛЬНО Вставьте в комментарий к переводу:
💬 <code>ОПЛАТА ЗА ПРИМЕРКИ от @{user.username or 'ваш_никнейм'}</code> <-- нажмите чтобы скопировать
