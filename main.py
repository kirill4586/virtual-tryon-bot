...
payment_note = f"<code>ОПЛАТА ЗА ПРИМЕРКИ от @{user.username}</code>"
...
payment_text = (
    ...
    "Сумма символическая, но помогает вам быть стильными, модными и красивыми.\n"
    "👗👔🩳👙👠👞👒👟🧢🧤👛👜\n\n"
    ...
    "- 90 руб = 3 примерки\n"
    "и так далее...\n\n"
    "1️⃣ Нажмите на кнопку 'Пополнить баланс' ниже\n"
    "2️⃣ Укажите любую сумму (не менее 30 руб)\n"
    "3️⃣ Выберите удобный способ оплаты (Карта или СБП)\n"
    "4️⃣ В поле <b>e-mail</b> можно указать любую почту (не имеет значения)\n\n"
    "💥 <b>ВСЁ!!!</b> 💥\n\n"
    "⚠️‼️ <b>ВНИМАНИЕ!</b> В поле для сообщений (под суммой оплаты) обязательно укажите следующее:\n\n"
    f"{payment_note}\n\n"
    "📋 Просто нажмите на это сообщение — оно скопируется, и вставьте его в поле для сообщений при оплате.\n\n"
    "🤷‍♂️ Иначе мы не поймем, кому начислять баланс!\n"
    "‼️ <b>Ничего не меняйте в сообщении</b> ‼️\n\n"
    "❓ Вы можете проверить свой баланс по кнопке 'Мой баланс' ниже."
)
